...
namespace Infrastructure.Identity.Constants
{
    ...
    public static class CimFeature
    {
        ...
        public const string Instrument_Allocation = nameof(Instrument_Allocation);
    ...
    public static class CimPermissions
    {
        ...
        [
            ...
            new CimPermission("View InstrumentAllocation", CimAction.View, CimFeature.Instrument_Allocation),
            new CimPermission("Create InstrumentAllocation", CimAction.Create, CimFeature.Instrument_Allocation),
            new CimPermission("Update InstrumentAllocation", CimAction.Update, CimFeature.Instrument_Allocation),
            new CimPermission("Delete InstrumentAllocation", CimAction.Delete, CimFeature.Instrument_Allocation),
